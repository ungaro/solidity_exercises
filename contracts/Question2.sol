...
function optimalEuropean(uint256 ipt, uint256 S, uint256 X, uint256 r, uint256 sigma, uint256 T, uint256 N, string optionType) public  pure returns (uint256) {


    uint256 dt = divd(uint256(T),uint256(N),18);
...
function sqrt(uint256 x) internal pure returns (uint256 result) {
    ...
    /// @return result The result as an unsigned 60.18-decimal fixed-point number.
    function exp2_(uint256 x) internal pure returns (uint256 result) {
        unchecked {
